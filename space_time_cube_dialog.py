...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'space_time_cube_dialog_base.ui'))


class SpaceTimeCubeDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SpaceTimeCubeDialog, self).__init__(parent)
